...
-- 2017-01-01,NKopp,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_NKopp')
	 Begin 
	  Alter Database [Assignment07DB_NKopp] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_NKopp;
	 End
	Create Database Assignment07DB_NKopp;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_NKopp;
...
AS
	...
	From vProducts as P
	 Join vInventories as I
	  On P.ProductID = I.ProductID
	Order By P.ProductName, Month(InventoryDate), InventoryCount;
go
